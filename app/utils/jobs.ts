...
export const jobs: JobType[] = [
  ...
  },
  {
    ...
    companyDescription: [
      ...
      "Additionally, unclebob.ro, besides other cool things they do, innovatively integrates self-service -vending machines- acting as a personal concierge with a bunch of light and weight sensors that simply know what you took from the shelf, to provide a faster and easier shopping experience.",
    ],
