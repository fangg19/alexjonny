...
These smart lockers/vending machines are designed to be a quick way to buy some essential products or to serve as a locker to leave or pick-up items.
ReactJS is used for the UI so I had the opportunity to work a little bit on this too, to develope new elements for a better UX.
